 ...
 * @author frb
 */
public class ShellAction extends AnAction {

    final static Logger log = Logger.getInstance(ShellAction.class.getName());

    /**
     * Creates a new action with its text, description and icon set to <code>null</code>.
     */
    public ShellAction() {
        Icon tIcon = Util.loadIcon("commandshell.png");
    ...
    public void actionPerformed(AnActionEvent pEvent) {
        ...
        Util.openCommandShell(tVirtualFile);
    }
